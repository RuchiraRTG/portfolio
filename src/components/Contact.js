...
import profile from "../assets/img/new_propic.png"; // Using the same propic from Banner
import { BotUpdater } from "./BotUpdater";
...
export const Contact = () => {
  ...
  return (
    <section className="contact-section" id="connect" ref={sectionRef}>
      <div className="container-main contact-centered">
        {/* CTA Header */}
        ...
        <h2 className="contact-main-title uppercase-title fade-up stagger-1">
          HAVE A PROJECT IN MIND?
        </h2>

        <p className="contact-subtitle fade-up stagger-2">
          Together, we can create something clear and impactful.
          Let's collaborate to bring our ideas to life in a way that resonates with everyone.
        </p>

        <a href="mailto:ruchiratharupathi01@gmail.com" className="contact-cta-btn fade-up stagger-3">
          Contact Me
        ...
        {/* Social Pill Row */}
        <div className="contact-social-row fade-up stagger-4">
          <div className="contact-name-pill">
            <img src={profile} alt="Ruchira" />
            Ruchira Tharupathi
          </div>
          <a href="https://wa.me/94769271275" target="_blank" rel="noreferrer" className="contact-social-pill">
